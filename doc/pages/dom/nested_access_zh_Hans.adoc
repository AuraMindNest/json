...
[#nested_access]
= 访问深层嵌套元素
为了便于便捷地获取和修改 &lt;<ref_value>&gt; 对象中深层嵌套的元素，该库实现了 https://datatracker.ietf.org/doc/html/rfc6901[RFC 6901 (JSON Pointer)]:</ref_value>
...
该库还支持修改和添加深层嵌套的元素。函数 &lt;<ref_value_set_at_pointer>&gt; 的遍历方式与 &lt;<ref_value_at_pointer>&gt; 类似，但在某些情况下还能创建缺失的元素：</ref_value_at_pointer></ref_value_set_at_pointer>
